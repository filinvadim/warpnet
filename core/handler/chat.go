...
type NodeUserFetcher interface {
...
func StreamGetUserChatsHandler(repo ChatStorer, userRepo NodeUserFetcher) middleware.WarpHandler {
	return func(buf []byte, s warpnet.WarpStream) (any, error) {
...
func StreamGetMessagesHandler(repo ChatStorer, userRepo NodeUserFetcher) middleware.WarpHandler {
	return func(buf []byte, s warpnet.WarpStream) (any, error) {
...
func StreamGetMessageHandler(repo ChatStorer, userRepo NodeUserFetcher) middleware.WarpHandler {
	return func(buf []byte, s warpnet.WarpStream) (any, error) {
